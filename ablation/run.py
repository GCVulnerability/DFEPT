...
def convert_examples_to_features(js,tokenizer,args):
    ...
    return InputFeatures(source_tokens,source_ids,js['hash'],js['label'])
...
def main():
    ...
    parser.add_argument('--feature_dim_size', type=int, default=768, help='feature_dim_size')
    ...
    model=ModelWithoutLLM(model,config,tokenizer,args)
