WORKDIR="/root/autodl-tmp/CodeT5/code"
...
elif [[ ${TASK} == 'defect_reveal' ]]; then
  RUN_FN=${WORKDIR}/run_defect.py
elif [[ ${TASK} == 'defect_mvd' ]]; then
  RUN_FN=${WORKDIR}/run_defect.py
elif [[ ${TASK} == 'defect_draper' ]]; then
  RUN_FN=${WORKDIR}/run_defect.py
elif [[ ${TASK} == 'defect_vuldeepecker' ]]; then
  RUN_FN=${WORKDIR}/run_defect.py
elif [[ ${TASK} == 'defect_bigvul' ]]; then
  RUN_FN=${WORKDIR}/run_defect.py
