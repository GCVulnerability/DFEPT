...
def get_sub_tasks(task):
    ...
    elif task in ['concode', 'defect', 'clone', 'multi_task', 'defect_reveal', 'defect_draper', 'defect_mvd', 'defect_bigvul', 'defect_vuldeepecker']:
        sub_tasks = ['none']
    return sub_tasks
...
if __name__ == '__main__':
    ...
    parser.add_argument("--task", type=str, default='summarize', choices=['summarize', 'concode', 'translate',
                                                                          'refine', 'defect', 'clone', 'defect_reveal', 'multi_task', 'defect_draper', 'defect_mvd', 'defect_bigvul', 'defect_vuldeepecker'])
    ...
    parser.add_argument("--gpu", type=int, default=-1, help='index of the gpu to use in a cluster')
